    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-[radial-gradient(circle_at_center,_rgba(59,130,246,0.25),_transparent_70%)] flex min-h-svh w-full",
            className
          )}
          {...props}
        >
