...
export default function TopBarKasir({ namaOutlet }: TopBarKasirProps) {
    ...
    const displayName =
        auth?.user?.name || localStorage.getItem('user_name') || 'Kasir';
            ...
            <div className="w-full px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    <div className="flex flex-1 items-center justify-center">
                        <h3 className="text-4xl font-bold text-white dark:text-gray-200">
                            Kasir Outlet {namaOutlet}
                        </h3>
                    </div>
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center gap-3 pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        <div className="hidden items-center gap-2.5 sm:flex">
                            ...
                            <div className="text-right">
                                ...
                                <p className="max-w-[180px] truncate text-sm leading-tight font-medium text-white">
                                    {displayName}
                                </p>
                            </div>
                        </div>
