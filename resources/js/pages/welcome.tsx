...
import { Menu, X, Sun, Moon, Search, LogInIcon } from 'lucide-react';
...
export default function LuxuryEcommerceHomepage(props: Readonly<Props>) {
    ...
    return (
        ...
        >
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between md:h-20">
                        ...
                        <div className="hidden items-center gap-5 md:flex lg:gap-7">
                            ...
                            <Link
                                href={login()}
                                className="flex items-center gap-2 text-sm font-medium text-blue-100 transition hover:text-white"
                            >
                                <LogInIcon size={18} />
                                <span>Login</span>
                            </Link>
                    ...
                    {mobileMenuOpen && (
                        ...
                        >
                            <div className="flex flex-col gap-1 px-5 py-4">
                                ...
                                <Link href={login()} className="flex items-center gap-3 rounded-lg px-4 py-3 text-base font-medium text-blue-100 transition hover:bg-blue-800/40 hover:text-white">
            ...
            >
                <h2 className="mb-8 bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-2xl font-semibold text-transparent sm:text-3xl lg:mb-14 lg:text-4xl">
                    Kategori
                </h2>
                    ...
                    >
                        {kategoris.map((kategori) => (
                            <motion.div
                                ...
                                key={kategori.id}
                                onClick={() => handleKategoriClick(kategori.id)}
                                className={`min-w-[160px] overflow-hidden rounded-2xl shadow-xl sm:min-w-[200px] lg:min-w-[240px] ${cardClass} snap-center cursor-pointer ${
                                    selectedKategori === kategori.id
            ...
            >
                <div className="mb-8 flex items-center justify-between">
                    <h2 className="bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-2xl font-semibold text-transparent sm:text-3xl lg:text-4xl">
                        {selectedKategori
                ...
                <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 sm:gap-6 md:grid-cols-4 lg:grid-cols-5 lg:gap-8 xl:grid-cols-6">
                    {filteredProducts.map((product) => (
                        <motion.div
                            ...
                            key={product.id}
                            className={`overflow-hidden rounded-2xl shadow-xl ${cardClass}`}
                        >
                            <div className="relative">
                                <img
                                    src={
