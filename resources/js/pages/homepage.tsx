...
import { Sun, Moon, ShoppingBag, Search, User, LogInIcon, LogOutIcon } from "lucide-react";
import { Head, Link, usePage } from '@inertiajs/react';
import { login, logout, myprofile } from '@/routes';
...
export default function homepage({ products, kategoris }: Props) {
        ...
        <div className="max-w-7xl mx-auto px-10 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <input
                type="text"
                placeholder="Cari..."
                className="w-100 border rounded px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-300"
            />
            ...
            >
                <LogOutIcon size={18}/>
                <span className="text-sm font-medium font-bold">Logout</span>
            </Link>
